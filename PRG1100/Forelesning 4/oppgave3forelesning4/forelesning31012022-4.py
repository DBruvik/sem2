def heleLista():
    ...
    print('Hele listen usortert', student)
    print()

    print('Hele lista sortert per person i komma separert orden:')
    print('Studentnr, fornavn, etternavn, e-post, fødselsdato, kjønn og studium')
    print('--------------------------------------------------------------------')
