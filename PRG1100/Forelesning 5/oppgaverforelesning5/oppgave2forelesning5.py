...
try:
    ...
    while studentnr!='':
        ...
        student[studentnr]={'fornavn':fornavn,'etternavn':etternavn,'epost':epost,'fødselsdato':fødselsdato,'kjønn':kjønn,'studium':studium}
